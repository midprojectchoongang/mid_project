...
<form action="join.member" method="post" name="frm" onsubmit="return chk()">
	<table class="w3-table w3-centered w3-bordered" style="max-width: 450px">
	<tr><th style="min-width: 125px">아이디</th><td style="text-align: left; margin-left: 20px">
		<input type="text" name="member_id" required="required" autofocus="autofocus">
		<a href="#" onclick="confirm()" style="margin-left: 10px; font-size:14px; font-weight: 900; color:gray;">중복 확인</a></td></tr>		
	<tr><th>암호</th><td style="text-align: left; margin-left: 20px">
		<input type="password" name="password" required="required"></td></tr>
	<tr><th>암호 확인</th><td style="text-align: left; margin-left: 20px">
		<input type="password" name="confrimPass" required="required"></td></tr>
	<tr><th>이름</th><td style="text-align: left; margin-left: 20px">
		<input type="text" name="name" required="required"></td></tr>
	<tr><th>성별</th><td style="text-align: left; margin-left: 20px">	
	...
	<tr><th>이메일</th><td style="text-align: left; margin-left: 20px">
		<input type="text" name="email" required="required">
	<tr><th>전화번호</th><td style="text-align: left; margin-left: 20px">
		<input type="tel" name="tel" required="required" pattern="\d{3}-\d{3,4}-\d{4}"
			placeholder="xxx-xxxx-xxxxx" title="전화번호 형식 xxx-xxxx-xxxx">	
	<tr><th>주소</th>
		<td style="text-align: left; margin-left: 20px"><select name="location_no">
	...
	<tr><th>경험</th>
	<td style="text-align: left; margin-left: 20px"><label for="e1">유</label>
		<input type="radio" name="experience" value="y" id="e1" required="required">
		<label for="e2">무</label>
		<input type="radio" name="experience" value="n" id="e2" required="required"></td>
</table><p>
	<input type="submit" value="회원가입" class="btn-two rounded charcoal small">
</form>
</div>
